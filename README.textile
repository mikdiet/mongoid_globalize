...
Mongoid 2.3. Mongoid 2.4 break some specs, so it's not supported yet. Though you can use + hem 'mongoid_globalize', '1.3.4'+, it's the same as last version, but allows using any 2.1+ version of Mongoid.
